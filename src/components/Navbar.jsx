    ...
    ${styles.paddingX} w-full flex items-center py-5 top-0 z-20 bg-[#0000006f]`}>
      <div className='w-full justify-between items-center max-w-7xl mx-auto flex'>
        ...
        >
          ...
          />
          <p 
          className='text-white text-[18px] font-bold cursor-pointer flex'> Vanessa  &nbsp; <span 
          className='sm:block hidden'> | Fullstack Dev |</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl opacity-40`}>
